...
#define FS2_OAUTH_KEY    (@"QGZFJEI1YC5EWQ4CAB24ENINQQ2U241B35HZJV0X5ZXA1DVA")
#endif

#ifndef FS2_OAUTH_SECRET
#define FS2_OAUTH_SECRET (@"P3NHYD20WHVTH2NNO4Q0I2SV0LTTCB2ZXBS25KQ5I3TT1JI0")
#endif

//2, don't forget to added app url in your info plist file CFBundleURLTypes
#ifndef FS2_REDIRECT_URL
#define FS2_REDIRECT_URL @"app://1budgetapp"
#endif

//3 update this date to use up-to-date Foursquare API
#ifndef FS2_API_VERSION
#define FS2_API_VERSION (@"20130505")
#endif
